...
export default function SearchBar() {
  ...
  return (
    <div className="absolute top-4 left-4 z-[500] w-[320px] sm:w-[360px]">
      <div className="flex items-center gap-2 bg-white dark:bg-slate-900 rounded-full shadow-lg border border-slate-200/70 dark:border-slate-700 px-4 py-2.5">
